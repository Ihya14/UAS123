...
/* Smarty version 4.2.1, created on 2023-01-12 14:26:46
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\controllers\products\images.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa826a16d66_72464692',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '644160cf7cad468334a5f4a270c350add7af35dc' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\controllers\\products\\images.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bfa826a16d66_72464692 (Smarty_Internal_Template $_smarty_tpl) {
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Edit this product\'s image:'),$_smarty_tpl ) );
} else {
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add a new image to this product'),$_smarty_tpl ) );
}?>
				</span>
			</label>
			<div class="col-lg-9">
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['images']->value[0]->legend[$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);
} else {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->name[$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<table id="lineType" style="display:none;">
		<tr id="image_id">
			<td>
				<a href="<?php echo (defined('_THEME_PROD_DIR_') ? constant('_THEME_PROD_DIR_') : null);?>
image_path.jpg" class="fancybox">
					<img
						src="<?php echo (defined('_THEME_PROD_DIR_') ? constant('_THEME_PROD_DIR_') : null);
echo $_smarty_tpl->tpl_vars['iso_lang']->value;?>
...
, "<?php if ($_smarty_tpl->tpl_vars['image']->value->cover) {?>icon-check-sign<?php } else { ?>icon-check-empty<?php }?>", assoc, "<?php echo mb_convert_encoding(htmlspecialchars((string)$_smarty_tpl->tpl_vars['image']->value->legend[$_smarty_tpl->tpl_vars['default_language']->value], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
");
			<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			$('.delete_product_image').die().live('click', function(e)
			{
				...
				if (confirm("<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Are you sure?','js'=>1),$_smarty_tpl ) );?>
"))
				doAdminAjax({
