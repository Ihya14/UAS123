...
/* Smarty version 4.2.1, created on 2023-01-12 14:26:44
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\controllers\products\combinations.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa8248fa099_21283624',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '300f77a737d5a1b514c2ba40266ddcfebc12e00f' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\controllers\\products\\combinations.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bfa8248fa099_21283624 (Smarty_Internal_Template $_smarty_tpl) {
...
>
	...
	<div class="alert alert-info">
        <?php $_smarty_tpl->_assignInScope('combinationGeneratorTag', "<a class='btn btn-link bt-icon confirm_leave' href=".((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink("AdminAttributeGenerator"))."&amp;id_product=".((string)$_smarty_tpl->tpl_vars['product']->value->id).">");?>
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'You can also use the [1]Product Combinations Generator[2/][/1] in order to automatically create a set of combinations.','tags'=>array($_smarty_tpl->tpl_vars['combinationGeneratorTag']->value,'<i class="icon-external-link-sign">')),$_smarty_tpl ) );?>
...
"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['attribute_group']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
&nbsp;&nbsp;</option>
					<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 .-_#">
			...
			<div class="col-lg-5">
				<input type="text" id="attribute_reference" name="attribute_reference" value="<?php echo $_smarty_tpl->tpl_vars['defaultReference']->value;?>
" />
			</div>
		</div>
		<div class="form-group">
...
echo $_smarty_tpl->tpl_vars['currency']->value->sign;
                    ...
                    <input type="text"
                        ...
                        value="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPriceValue'][0], array( array('price'=>0),$_smarty_tpl ) );?>
"
                ...
                <span class="help-block">
                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Overrides the wholesale price from the \'Prices\' tab.'),$_smarty_tpl ) );?>

                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Leave blank if the price does not change.'),$_smarty_tpl ) );?>
...
.jpg" alt="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['image']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['image']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
" />
						</label>
					</li>
					<?php
