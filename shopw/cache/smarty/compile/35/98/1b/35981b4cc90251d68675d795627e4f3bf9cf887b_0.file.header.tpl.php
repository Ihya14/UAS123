...
/* Smarty version 4.2.1, created on 2023-01-12 13:39:18
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bf9d061fbe58_74717269',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35981b4cc90251d68675d795627e4f3bf9cf887b' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\header.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bf9d061fbe58_74717269 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\xampp\\htdocs\\shopw\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.explode.php','function'=>'smarty_modifier_explode',),));
?>
<!DOCTYPE html>
...
';
		var _PS_VERSION_ = '<?php echo addcslashes((defined('_TB_VERSION_') ? constant('_TB_VERSION_') : null),'\'');?>
';
		var roundMode = <?php echo intval($_smarty_tpl->tpl_vars['round_mode']->value);?>
;
		var autorefresh_notifications = <?php echo intval($_smarty_tpl->tpl_vars['autorefresh_notifications']->value);?>
;
...
';
		var errorLogin = '<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'thirty bees was unable to log in to Addons. Please check your credentials and your Internet connection.','js'=>1),$_smarty_tpl ) );?>
';
...
} else { ?> page-topbar<?php }?> <?php echo strtolower(htmlspecialchars((string)$_GET['controller'], ENT_QUOTES, 'UTF-8', true));?>
">
		...
		<nav id="header_infos" role="navigation">
			<div class="navbar-header">
				...
				<a id="header_shopversion" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['default_tab_link']->value, ENT_QUOTES, 'UTF-8', true);?>
">
				...
				<?php } else { ?>
					<a id="header_shopname" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['default_tab_link']->value, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo $_smarty_tpl->tpl_vars['shop_name']->value;?>
				...
				<?php }?>
					...
					<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['notificationTypes']->value, 'notificationType');
$_smarty_tpl->tpl_vars['notificationType']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['notificationType']->value) {
$_smarty_tpl->tpl_vars['notificationType']->do_else = false;
?>
						<li id="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['type'];?>
_notif" class="dropdown" data-type="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['type'];?>
" data-last-id="0">
							<a href="javascript:void(0);" class="dropdown-toggle notifs" data-toggle="dropdown">
								<i class="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['icon'];?>
"></i>
								<span id="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['type'];?>
_notif_number_wrapper" class="notifs_badge hide">
									<span id="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['type'];?>
_notif_value">0</span>
								</span>
							</a>
							<div class="dropdown-menu notifs_dropdown">
								<section id="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['type'];?>
_notif_wrapper" class="notifs_panel">
									<div class="notifs_panel_header">
										<h3><?php echo $_smarty_tpl->tpl_vars['notificationType']->value['header'];?>
</h3>
									</div>
									<div id="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['type'];?>
_notif_list" class="list_notif">
										<span class="no_notifs"><?php echo $_smarty_tpl->tpl_vars['notificationType']->value['emptyMessage'];?>
</span>
									</div>
									<div class="notifs_panel_footer">
										<a href="<?php echo $_smarty_tpl->tpl_vars['notificationType']->value['showAllLink'];?>
"><?php echo $_smarty_tpl->tpl_vars['notificationType']->value['showAll'];?>
</a>
									</div>
								</section>
							</div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
						<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'displayAdminHeaderNotif'),$_smarty_tpl ) );?>
...
', '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( strtr((string)$_smarty_tpl->tpl_vars['quick_access_current_link_name']->value[0], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" )),32 ));?>
');
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['base_url']->value, ENT_QUOTES, 'UTF-8', true);
...
">
							<span class="string-long"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'My shop'),$_smarty_tpl ) );?>
</span>
							<span class="string-short"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Shop'),$_smarty_tpl ) );?>
</span>
						</a>
						<?php if ((isset($_smarty_tpl->tpl_vars['maintenance_mode']->value)) && $_smarty_tpl->tpl_vars['maintenance_mode']->value == true) {?>
							<span class="maintenance-mode">
								&mdash;
								<a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminMaintenance'), ENT_QUOTES, 'UTF-8', true);?>
">
									<span class="label-tooltip"
										  data-toggle="tooltip"
										  data-placement="bottom"
										  data-html="true"
										  title="<p class='text-left text-nowrap'><strong><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Your shop is in maintenance.'),$_smarty_tpl ) );?>
										 ...
										 <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Maintenance mode'),$_smarty_tpl ) );?>
...
<?php }?>
					<li id="employee_infos" class="dropdown">
						<a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminEmployees'), ENT_QUOTES, 'UTF-8', true);?>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['employee']->value->lastname;?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['employee']->value->lastname;?>
							...
							<li class="divider"></li>
							<li><a href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminEmployees'), ENT_QUOTES, 'UTF-8', true);?>
&amp;id_employee=<?php echo intval($_smarty_tpl->tpl_vars['employee']->value->id);?>
&amp;updateemployee"><i class="icon-wrench"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'My preferences'),$_smarty_tpl ) );?>
							...
							<li class="divider"></li>
							<li><a id="header_logout" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['login_link']->value, ENT_QUOTES, 'UTF-8', true);?>
