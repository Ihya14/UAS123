...
/* Smarty version 4.2.1, created on 2023-01-12 14:26:44
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\controllers\products\shipping.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa824103ca8_44831843',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b8c9f21be73005a922b5c43526ae843da7935338' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\controllers\\products\\shipping.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bfa824103ca8_44831843 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="product-shipping" class="panel product-tab">
	...
	<?php $_smarty_tpl->_subTemplateRender("file:controllers/products/multishop/check_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('product_tab'=>"Shipping"), 0, false);
?>

	<div class="form-group">
		<label class="control-label col-lg-2 col-lg-offset-1" for="width"><?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />
	...
	<div class="form-group">
		<label class="control-label col-lg-2 col-lg-offset-1" for="height"><?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />
	...
	<div class="form-group">
		<label class="control-label col-lg-2 col-lg-offset-1" for="depth"><?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />
	...
	<div class="form-group">
		<label class="control-label col-lg-2 col-lg-offset-1" for="weight"><?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" />
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right"><?php $_smarty_tpl->_subTemplateRender("file:controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('field'=>"additional_shipping_cost",'type'=>"default"), 0, false);
?></span></div>
...
">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Additional shipping fees'),$_smarty_tpl ) );?>
...
" />
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right"><?php $_smarty_tpl->_subTemplateRender("file:controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('field'=>"carrierSelection",'type'=>"selection"), 0, true);
?></span></div>
		<label class="control-label col-lg-2" for="availableCarriers"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Carriers'),$_smarty_tpl ) );?>
</label>
		<div class="col-lg-9">
