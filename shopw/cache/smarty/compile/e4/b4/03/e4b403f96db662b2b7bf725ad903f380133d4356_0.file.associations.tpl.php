...
/* Smarty version 4.2.1, created on 2023-01-12 14:26:45
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\controllers\products\associations.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa825531874_29091538',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e4b403f96db662b2b7bf725ad903f380133d4356' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\controllers\\products\\associations.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bfa825531874_29091538 (Smarty_Internal_Template $_smarty_tpl) {
...
?></span></div>
		...
		<div class="col-lg-9">
			...
			<a class="btn btn-link bt-icon confirm_leave" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCategories'), ENT_QUOTES, 'UTF-8', true);?>
&amp;addcategory">
				<i class="icon-plus-sign"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Create new category'),$_smarty_tpl ) );?>
...
?></span></div>
		<label class="control-label col-lg-2" for="id_category_default">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The default category is the main category for your product, and is displayed by default.'),$_smarty_tpl ) );?>
">
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['accessory']->value) {
$_smarty_tpl->tpl_vars['accessory']->do_else = false;
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
¤<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>" />
...
">
				...
				<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true);
...
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['product']->value->manufacturer_name;?>
		...
		<div class="col-lg-4">
			<a class="btn btn-link bt-icon confirm_leave" style="margin-bottom:0" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminManufacturers'), ENT_QUOTES, 'UTF-8', true);?>
&amp;addmanufacturer">
