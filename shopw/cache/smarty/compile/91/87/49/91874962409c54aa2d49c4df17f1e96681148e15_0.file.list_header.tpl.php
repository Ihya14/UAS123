<?php
/* Smarty version 4.2.1, created on 2023-01-12 13:39:16
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\helpers\list\list_header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bf9d045f31f4_03323065',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '91874962409c54aa2d49c4df17f1e96681148e15' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\helpers\\list\\list_header.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bf9d045f31f4_03323065 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\xampp\\htdocs\\shopw\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php','function'=>'smarty_function_math',),));
...
').find(".ajax_table_link").click(function () {
				var link = $(this);
...
<?php if (!$_smarty_tpl->tpl_vars['simple_header']->value) {?>
	<div class="leadin">
		<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_125201021863bf9d04584c62_97351346', "leadin");
?>
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_48402664063bf9d045864e2_23566429', "override_header");
?>
...
<?php if ((isset($_smarty_tpl->tpl_vars['sql']->value)) && $_smarty_tpl->tpl_vars['sql']->value) {?>
	<form id="sql_form_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
" action="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminRequestSql'), ENT_QUOTES, 'UTF-8', true);?>
&amp;addrequest_sql" method="post" class="hide">
		<input type="hidden" id="sql_query_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
" name="sql" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['sql']->value, ENT_QUOTES, 'UTF-8', true);?>
"/>
		<input type="hidden" id="sql_name_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
" name="name" value=""/>
	</form>
<?php }?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_74425990763bf9d045a1156_15999130', "startForm");
?>
...
"/>
	<?php ob_start();
echo (("id_").($_smarty_tpl->tpl_vars['list_id']->value)).("_category");
$_prefixVariable1=ob_get_clean();
if (strpos($_SERVER['REQUEST_URI'],$_prefixVariable1) !== false) {?>
		<?php if ((isset($_GET[(("id_").($_smarty_tpl->tpl_vars['list_id']->value)).("_category")]))) {?>
			<input type="hidden" name="<?php echo (("id_").($_smarty_tpl->tpl_vars['list_id']->value)).("_category");?>
" value="<?php echo intval($_GET[(("id_").($_smarty_tpl->tpl_vars['list_id']->value)).("_category")]);?>
"/>
		<?php }?>
	<?php }?>
	<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_164445621863bf9d045ad862_04919517', "override_form_extra");
?>
...
}?>" class="list-toolbar-btn<?php if ((isset($_smarty_tpl->tpl_vars['btn']->value['target'])) && $_smarty_tpl->tpl_vars['btn']->value['target']) {?> _blank<?php }?>"<?php if ((isset($_smarty_tpl->tpl_vars['btn']->value['href']))) {?> href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['btn']->value['href'], ENT_QUOTES, 'UTF-8', true);?>
"<?php }
...
" data-html="true" data-placement="top">
				...
				<?php if ((isset($_smarty_tpl->tpl_vars['sql']->value)) && $_smarty_tpl->tpl_vars['sql']->value) {?>
					...
					<?php if ($_smarty_tpl->tpl_vars['sql_manager']->value['view'] == 1) {?>
						<a class="list-toolbar-btn" href="javascript:void(0);" onclick="$('.leadin').first().append('<div class=\'alert alert-info\'>' + $('#sql_query_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" data-html="true" data-placement="top" >
						...
						<a class="list-toolbar-btn" href="javascript:void(0);" onclick="$('#sql_name_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
').val(createSqlQueryName()); $('#sql_query_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
').val($('#sql_query_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
').val().replace(/\s+limit\s+[0-9,\s]+$/ig, '').trim()); $('#sql_form_<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['list_id']->value, ENT_QUOTES, 'UTF-8', true);?>
').submit();">
...
-save').click();
						...
						//submit the form
						<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_163365862863bf9d045c3a03_45203572', 'formSubmit');
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_179380186663bf9d045cb187_37030275', "preTable");
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
							...
							<?php if ((!(isset($_smarty_tpl->tpl_vars['params']->value['orderby'])) || $_smarty_tpl->tpl_vars['params']->value['orderby']) && !$_smarty_tpl->tpl_vars['simple_header']->value && $_smarty_tpl->tpl_vars['show_filters']->value) {?>
								<a <?php if ((isset($_smarty_tpl->tpl_vars['order_by']->value)) && ($_smarty_tpl->tpl_vars['key']->value == $_smarty_tpl->tpl_vars['order_by']->value) && ($_smarty_tpl->tpl_vars['order_way']->value == 'DESC')) {?>class="active"<?php }?> href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
Orderby=<?php echo urlencode($_smarty_tpl->tpl_vars['key']->value);?>
&amp;<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
Orderway=desc&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);
...
=<?php echo intval($_GET[$_smarty_tpl->tpl_vars['identifier']->value]);
								...
								<a <?php if ((isset($_smarty_tpl->tpl_vars['order_by']->value)) && ($_smarty_tpl->tpl_vars['key']->value == $_smarty_tpl->tpl_vars['order_by']->value) && ($_smarty_tpl->tpl_vars['order_way']->value == 'ASC')) {?>class="active"<?php }?> href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currentIndex']->value, ENT_QUOTES, 'UTF-8', true);?>
&amp;<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
Orderby=<?php echo urlencode($_smarty_tpl->tpl_vars['key']->value);?>
&amp;<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
Orderway=asc&amp;token=<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['token']->value, ENT_QUOTES, 'UTF-8', true);
if ((isset($_GET[$_smarty_tpl->tpl_vars['identifier']->value]))) {?>&amp;<?php echo $_smarty_tpl->tpl_vars['identifier']->value;?>
=<?php echo intval($_GET[$_smarty_tpl->tpl_vars['identifier']->value]);
}?>">
...
echo $_smarty_tpl->tpl_vars['key']->value;
}?>" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['params']->value['value'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }
/* {block "leadin"} */
class Block_125201021863bf9d04584c62_97351346 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'leadin' => 
  array (
    0 => 'Block_125201021863bf9d04584c62_97351346',
  ),
);
...
class Block_48402664063bf9d045864e2_23566429 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_header' => 
  array (
    0 => 'Block_48402664063bf9d045864e2_23566429',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
}
...
/* {/block "override_header"} */
/* {block "startForm"} */
class Block_74425990763bf9d045a1156_15999130 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'startForm' => 
  array (
    0 => 'Block_74425990763bf9d045a1156_15999130',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_164445621863bf9d045ad862_04919517 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_form_extra' => 
  array (
    0 => 'Block_164445621863bf9d045ad862_04919517',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
}
...
/* {/block "override_form_extra"} */
/* {block 'formSubmit'} */
class Block_163365862863bf9d045c3a03_45203572 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'formSubmit' => 
  array (
    0 => 'Block_163365862863bf9d045c3a03_45203572',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block 'formSubmit'} */
/* {block "preTable"} */
class Block_179380186663bf9d045cb187_37030275 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'preTable' => 
  array (
    0 => 'Block_179380186663bf9d045cb187_37030275',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
}
