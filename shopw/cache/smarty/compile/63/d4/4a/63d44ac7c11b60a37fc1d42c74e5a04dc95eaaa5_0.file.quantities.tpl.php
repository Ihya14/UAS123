<?php
/* Smarty version 4.2.1, created on 2023-01-12 14:26:45
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\controllers\products\quantities.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa82529fde8_83208633',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '63d44ac7c11b60a37fc1d42c74e5a04dc95eaaa5' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\controllers\\products\\quantities.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bfa82529fde8_83208633 (Smarty_Internal_Template $_smarty_tpl) {
				...
				<div class="form-group" <?php if ($_smarty_tpl->tpl_vars['product']->value->is_virtual) {?>style="display:none;"<?php }?> class="row stockForVirtualProduct">
					<div class="col-lg-9 col-lg-offset-3">
						<p class="checkbox">
							...
							<?php if ($_smarty_tpl->tpl_vars['stock_management_active']->value == 0 && !$_smarty_tpl->tpl_vars['isPack']->value) {?>
							...
							<?php } elseif ($_smarty_tpl->tpl_vars['isPack']->value) {?>
						...
						<p class="radio">
							<label for="depends_on_stock_1">
								<input type="radio"
									   ...
									   value="<?php echo AdminProductsController::QUANTITY_METHOD_ASM;?>
"
									<?php if ($_smarty_tpl->tpl_vars['product']->value->depends_on_stock == 1 && $_smarty_tpl->tpl_vars['stock_management_active']->value == 1 && $_smarty_tpl->tpl_vars['product']->value->pack_dynamic == 0) {?>
										checked="checked"
									<?php }?>
								...
								<?php if (($_smarty_tpl->tpl_vars['stock_management_active']->value == 0 || $_smarty_tpl->tpl_vars['product']->value->advanced_stock_management == 0) && !$_smarty_tpl->tpl_vars['isPack']->value) {?> &nbsp;-&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'This requires you to enable advanced stock management globally or for this product.'),$_smarty_tpl ) );?>

								<?php }?>
							</label>
						</p>
						<?php if ($_smarty_tpl->tpl_vars['isPack']->value) {?>
							<p class="help-block">
							...
							<p class="radio">
								<label for="depends_on_stock_2" for="depends_on_stock_2">
									<input type="radio"
										   ...
										   name="depends_on_stock"
										   class="depends_on_stock"
										   value="<?php echo AdminProductsController::QUANTITY_METHOD_DYNAMIC_PACK;?>
"
										 <?php if ($_smarty_tpl->tpl_vars['product']->value->pack_dynamic == 1) {?>
										 	checked="checked"
										 <?php }?>
									/>
									<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Calculate pack quantities automatically based on available quantities of items in pack'),$_smarty_tpl ) );?>
						...
						<p class="radio">
							<label for="depends_on_stock_0" for="depends_on_stock_0">
								<input type="radio"
									   ...
									   name="depends_on_stock"
									   class="depends_on_stock"
									   value="<?php echo AdminProductsController::QUANTITY_METHOD_MANUAL;?>
"
									<?php if (($_smarty_tpl->tpl_vars['product']->value->depends_on_stock == 0 || $_smarty_tpl->tpl_vars['stock_management_active']->value == 0) && $_smarty_tpl->tpl_vars['product']->value->pack_dynamic == 0) {?>
										checked="checked"
									<?php }?>
								/>
				...
				<div class="form-group" <?php if (!$_smarty_tpl->tpl_vars['isPack']->value) {?>style="display:none"<?php }?>>
						...
						<p class="radio">
							<label id="label_pack_stock_1" for="pack_stock_type_1">
								<input type="radio"
									   ...
									   value="<?php echo Pack::STOCK_TYPE_DECREMENT_PACK;?>
"
									   name="pack_stock_type"
									   id="pack_stock_type_1"
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_stock_type == Pack::STOCK_TYPE_DECREMENT_PACK) {?>
										checked="checked"
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_dynamic) {?>
										disabled="disabled"
									<?php }?>
								/>
						...
						<p class="radio">
							<label id="label_pack_stock_2" for="pack_stock_type_2">
								<input type="radio"
									   class="pack_stock_type"
									   value="<?php echo Pack::STOCK_TYPE_DECREMENT_PRODUCTS;?>
"
									   name="pack_stock_type"
									   id="pack_stock_type_2"
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_stock_type == Pack::STOCK_TYPE_DECREMENT_PRODUCTS) {?>
										checked="checked"
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_dynamic) {?>
										disabled="disabled"
						...
						<p class="radio">
							<label id="label_pack_stock_3" for="pack_stock_type_3">
								<input type="radio"
									   class="pack_stock_type"
									   value="<?php echo Pack::STOCK_TYPE_DECREMENT_PACK_AND_PRODUCTS;?>
"
									   name="pack_stock_type"
									   id="pack_stock_type_3"
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_stock_type == Pack::STOCK_TYPE_DECREMENT_PACK_AND_PRODUCTS) {?>
										checked="checked"
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_dynamic) {?>
										disabled="disabled"
						...
						<p class="radio">
							<label id="label_pack_stock_4" for="pack_stock_type_4">
								<input type="radio"
									   class="pack_stock_type"
									   value="<?php echo Pack::STOCK_TYPE_DECREMENT_GLOBAL_SETTINGS;?>
"
									   name="pack_stock_type" id="pack_stock_type_4"
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_stock_type == Pack::STOCK_TYPE_DECREMENT_GLOBAL_SETTINGS) {?>
										checked="checked"
									<?php }?>
									<?php if ($_smarty_tpl->tpl_vars['product']->value->pack_dynamic) {?>
										disabled="disabled"
...
">
										<span id="qty_text_<?php echo $_smarty_tpl->tpl_vars['attribute']->value['id_product_attribute'];?>
">
											<?php echo $_smarty_tpl->tpl_vars['available_quantity']->value[$_smarty_tpl->tpl_vars['attribute']->value['id_product_attribute']];?>

										</span>
										<input type="text"
											   id="qty_input_<?php echo $_smarty_tpl->tpl_vars['attribute']->value['id_product_attribute'];?>
"
											   name="qty_<?php echo $_smarty_tpl->tpl_vars['attribute']->value['id_product_attribute'];?>
"
											   class="fixed-width-sm"
											   value="<?php echo htmlentities($_smarty_tpl->tpl_vars['available_quantity']->value[$_smarty_tpl->tpl_vars['attribute']->value['id_product_attribute']]);?>
"
										/>
									</td>
...
?></span></div>
				...
				<div class="col-lg-9">
					<input type="text" id="minimal_quantity" name="minimal_quantity" class="form-control fixed-width-sm" maxlength="6" value="<?php echo (($tmp = $_smarty_tpl->tpl_vars['product']->value->minimal_quantity ?? null)===null||$tmp==='' ? 1 ?? null : $tmp);?>
" />
...
" class="datepicker" type="text" />
			...
			<?php } else { ?>
			<div class="form-group">
				<p class="help-block col-lg-12"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'This product has combinations, set eventual availability dates there.'),$_smarty_tpl ) );?>
</p>
			</div>
			<?php }?>
		<?php }?>
