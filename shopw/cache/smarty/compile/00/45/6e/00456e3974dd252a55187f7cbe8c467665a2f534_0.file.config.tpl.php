...
/* Smarty version 4.2.1, created on 2023-01-12 23:15:19
  from 'D:\xampp\htdocs\shopw\modules\dashgoals\views\templates\hook\config.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63c02407c76fc4_63530368',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '00456e3974dd252a55187f7cbe8c467665a2f534' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\modules\\dashgoals\\views\\templates\\hook\\config.tpl',
      1 => 1562404679,
      2 => 'file',
    ),
  ),
...
function content_63c02407c76fc4_63530368 (Smarty_Internal_Template $_smarty_tpl) {
?>
<section id="dashgoals_config" class="dash_config hide">
  ...
  <form class="defaultForm form-horizontal" method="post"
        action="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminDashboard'), ENT_QUOTES, 'UTF-8', true);?>
">
...
"/>
            ...
            <td>
              <div class="input-group">
                <span class="input-group-addon"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['currency']->value->iso_code, ENT_QUOTES, 'UTF-8', true);?>
</span>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="panel-footer">
      <button class="btn btn-default pull-right" name="submitDashGoals" type="submit"><i
                class="process-icon-save"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Save','mod'=>'dashgoals'),$_smarty_tpl ) );?>
</button>
    </div>
  </form>
</section>
