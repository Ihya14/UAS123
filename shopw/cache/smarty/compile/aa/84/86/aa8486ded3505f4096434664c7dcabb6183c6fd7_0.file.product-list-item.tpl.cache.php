...
/* Smarty version 4.2.1, created on 2023-01-12 13:55:50
  from 'D:\xampp\htdocs\shopw\themes\niara\product-list-item.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa0e6168cd5_29313919',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'aa8486ded3505f4096434664c7dcabb6183c6fd7' => 
    array (
...
function content_63bfa0e6168cd5_29313919 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '194079620263bfa0e60b2141_57009672';
?>
<article>
    <div class="product-container" itemscope itemtype="https://schema.org/Product">
        <div class="product-image-container">
            <a class="product_img_link"
               href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
"
              ...
              <?php if (!empty($_smarty_tpl->tpl_vars['lazy_load']->value)) {?>
                <noscript>
                  <img class="img-responsive center-block"
                       src="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home',null,ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
"
                       srcset="
                     <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_smallest',null,ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
 211w,
                     <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_smaller',null,ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
 218w,
                     <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home',null,ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
 250w"
                       sizes="(min-width: 1200px) 250px, (min-width: 992px) 218px, (min-width: 768px) 211px, 250px"
                       alt="<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['legend'])) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['legend'], ENT_QUOTES, 'UTF-8', true);
} else {
...
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);
                       ...
                       itemprop="image"
                       width="<?php echo intval(call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getWidthSize'][0], array( array('type'=>'home'),$_smarty_tpl ) ));?>
"
                       height="<?php echo intval(call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getHeightSize'][0], array( array('type'=>'home'),$_smarty_tpl ) ));?>
"
                  >
                </noscript>
              <?php }?>
              <picture <?php if ($_smarty_tpl->tpl_vars['lazy_load']->value) {?>class="tb-lazy-image"<?php }?>>
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['webp']->value)) {?>
                  <source class="img-responsive center-block"
                          ...
                          <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_smallest','webp',ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
 211w,
                          <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_smaller','webp',ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
 218w,
                          <?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home','webp',ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
 250w"
                          sizes="(min-width: 1200px) 250px, (min-width: 992px) 218px, (min-width: 768px) 211px, 250px"
                          title="<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['legend'])) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['legend'], ENT_QUOTES, 'UTF-8', true);
...
"
                >
                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0], array( array('h'=>'productImageHover','id_product'=>$_smarty_tpl->tpl_vars['product']->value['id_product']),$_smarty_tpl ) );?>

                <?php if ((isset($_smarty_tpl->tpl_vars['quick_view']->value)) && $_smarty_tpl->tpl_vars['quick_view']->value) {?>
                <a class="quick-view show-if-product-item-hover"
                   href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
"
                   title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Open quick view window'),$_smarty_tpl ) );?>
"
                   data-fancybox-target="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
"
                >
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_functional_buttons']->value) {?>
                <div class="functional-buttons clearfix show-if-product-grid-hover">
                    ...
                    <?php if ((isset($_smarty_tpl->tpl_vars['comparator_max_item']->value)) && $_smarty_tpl->tpl_vars['comparator_max_item']->value) {?>
                        <div class="compare">
                            <a class="add_to_compare" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add to Compare'),$_smarty_tpl ) );?>
" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
"
                               data-id-product="<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
">
                                <i class="icon icon-plus"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add to Compare'),$_smarty_tpl ) );?>
...
echo (intval($_smarty_tpl->tpl_vars['product']->value['pack_quantity'])).(' x ');
                ...
                <a class="product-name" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
"
                   title="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" itemprop="url">
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
                            <a class="ajax_add_to_cart_button btn btn-primary"
                               href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,NULL,$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'default'),false), ENT_QUOTES, 'UTF-8', true);?>
"
...
echo intval($_smarty_tpl->tpl_vars['product']->value['minimal_quantity']);
                                ...
                                <span><i class="icon icon-shopping-basket"></i><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add to cart'),$_smarty_tpl ) );?>
</span>
                            </a>
                        <?php } else { ?>
              ...
              <span><i class="icon icon-shopping-basket"></i><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Add to cart'),$_smarty_tpl ) );?>
                        ...
                        <?php }?>
                    <?php }?>
                    <!--<a class="btn btn-default" href="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'In Stock'),$_smarty_tpl ) );
                        ...
                        <?php } elseif (((isset($_smarty_tpl->tpl_vars['product']->value['quantity_all_versions'])) && $_smarty_tpl->tpl_vars['product']->value['quantity_all_versions'] > 0)) {?>
                            <span class="label label-warning"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Product available with different options'),$_smarty_tpl ) );?>
</span>
                        <?php } else { ?>
                            <span class="label label-danger"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Out of stock'),$_smarty_tpl ) );?>
</span>
                        <?php }?>
                    </div>
                <?php }?>
