...
/* Smarty version 4.2.1, created on 2023-01-12 23:15:20
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\helpers\calendar\calendar.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63c024082dd687_28840059',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '86a2a3f7263f0e8b062ad47e20d2293f7f264cd4' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\helpers\\calendar\\calendar.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63c024082dd687_28840059 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<div class="daterangepicker-days">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4">
					<div class="datepicker2" data-date="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_to']->value, ENT_QUOTES, 'UTF-8', true);?>
" data-date-format="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_format']->value, ENT_QUOTES, 'UTF-8', true);?>
"></div>
				</div>
				<div class="col-sm-6 col-lg-4">
					<div class="datepicker1" data-date="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_from']->value, ENT_QUOTES, 'UTF-8', true);?>
" data-date-format="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_format']->value, ENT_QUOTES, 'UTF-8', true);?>
"></div>
				</div>
				<?php } else { ?>
...
echo $_smarty_tpl->tpl_vars['actions']->value[0]['label'];?>
							...
							<div class='form-date-body'>
								...
								<input class='date-input form-control' id='date-start' placeholder='Start' type='text' name="date_from" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_from']->value, ENT_QUOTES, 'UTF-8', true);?>
" data-date-format="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_format']->value, ENT_QUOTES, 'UTF-8', true);?>
" tabindex="1" />
								...
								<input class='date-input form-control' id='date-end' placeholder='End' type='text' name="date_to" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_to']->value, ENT_QUOTES, 'UTF-8', true);?>
" data-date-format="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_format']->value, ENT_QUOTES, 'UTF-8', true);?>
" tabindex="2" />
							</div>
						</div>
...
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Custom'),$_smarty_tpl ) );?>
							...
							<div class="form-date-body" id="form-date-body-compare"<?php if (is_null($_smarty_tpl->tpl_vars['compare_date_from']->value) || is_null($_smarty_tpl->tpl_vars['compare_date_to']->value)) {?> style="display: none;"<?php }?>>
								...
								<input id="date-start-compare" class="date-input form-control" type="text" placeholder="Start" name="compare_date_from" value="<?php if ((isset($_smarty_tpl->tpl_vars['compare_date_from']->value))) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['compare_date_from']->value, ENT_QUOTES, 'UTF-8', true);
}?>" data-date-format="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_format']->value, ENT_QUOTES, 'UTF-8', true);?>
" tabindex="4" />
								<label><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'to'),$_smarty_tpl ) );?>
</label>
								<input id="date-end-compare" class="date-input form-control" type="text" placeholder="End" name="compare_date_to" value="<?php if ((isset($_smarty_tpl->tpl_vars['compare_date_to']->value))) {
echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['compare_date_to']->value, ENT_QUOTES, 'UTF-8', true);
}?>" data-date-format="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['date_format']->value, ENT_QUOTES, 'UTF-8', true);?>
"
								tabindex="5" />
							</div>
