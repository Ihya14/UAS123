<?php
/* Smarty version 4.2.1, created on 2023-01-12 14:26:40
  from 'D:\xampp\htdocs\shopw\admin622ozp8ob\themes\default\template\controllers\products\informations.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_63bfa820e4bbe3_24061438',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e89c51679e5b34b51a323c6c62c37b64747c7928' => 
    array (
      0 => 'D:\\xampp\\htdocs\\shopw\\admin622ozp8ob\\themes\\default\\template\\controllers\\products\\informations.tpl',
      1 => 1668409880,
      2 => 'file',
    ),
  ),
...
function content_63bfa820e4bbe3_24061438 (Smarty_Internal_Template $_smarty_tpl) {
...
<div id="product-informations" class="panel product-tab">
 ...
 type="text/javascript">
		...
		var msg_select_one = "<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Please select at least one product.','js'=>1),$_smarty_tpl ) );?>
";
		var msg_set_quantity = "<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Please set a quantity to add a product.','js'=>1),$_smarty_tpl ) );?>
";
...
">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The public name for this product.'),$_smarty_tpl ) );?>
...
">
 ...
 <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'UPC barcode'),$_smarty_tpl ) );?>
		...
		<div class="col-lg-3">
			<input maxlength="12" type="text" id="upc" name="upc" value="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product']->value->upc, ENT_QUOTES, 'UTF-8', true);?>
" />
		</div>
	</div>
	...
	<hr/>
		...
		<?php if ((isset($_smarty_tpl->tpl_vars['active_per_store']->value))) {?>
	<div class="form-group">
		...
		<div class="col-lg-9">
			<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['active_per_store']->value, 'shopInfo', false, 'shopId');
$_smarty_tpl->tpl_vars['shopInfo']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['shopId']->value => $_smarty_tpl->tpl_vars['shopInfo']->value) {
$_smarty_tpl->tpl_vars['shopInfo']->do_else = false;
?>
				<div class="checkbox">
					<label>
						<input name="active_per_store[<?php echo $_smarty_tpl->tpl_vars['shopId']->value;?>
]" type="checkbox" value="<?php echo intval($_smarty_tpl->tpl_vars['shopInfo']->value['active']);?>
" <?php if ($_smarty_tpl->tpl_vars['shopInfo']->value['active']) {?>checked="checked"<?php }?>/>
						<?php echo mb_convert_encoding(htmlspecialchars((string)$_smarty_tpl->tpl_vars['shopInfo']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
?></span></div>
	...
	<?php }?>
		...
		<?php if ((isset($_smarty_tpl->tpl_vars['product_asso_shops']->value))) {?>
	<div class="form-group">
		<div class="col-lg-1"></div>
		<label class="control-label col-lg-2" for="checkBoxShopAsso_product">
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Shop associations'),$_smarty_tpl ) );?>

		</label>
		<div class="col-lg-5"><?php echo $_smarty_tpl->tpl_vars['product_asso_shops']->value;?>
</div>
...
;
			var product_name_redirected = '<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['product_name_redirected']->value, ENT_QUOTES, 'UTF-8', true);?>
';
		<?php echo '</script'; ?>
>
	</div>
...
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Appears in the body of the product page.'),$_smarty_tpl ) );?>
">
...
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Will be displayed in the tags block when enabled. Tags help customers easily find your products.'),$_smarty_tpl ) );?>
">
